...
urlpatterns = [
    ...
    url('(?P<empleado_slug>[\w-]+)/(?P<cliente_slug>[\w-]+)/nuevo-cobro/$', views.CrearCobro, name='nuevo_cobro'),
    url('(?P<empleado_slug>[\w-]+)/(?P<cliente_slug>[\w-]+)/(?P<cobro_slug>[\w-]+)/eliminar/$', views.EliminarCobro.as_view(), name='eliminar_cobro'),
    # EDITAR COBRO
    url('(?P<empleado_slug>[\w-]+)/(?P<cliente_slug>[\w-]+)/(?P<cobro_slug>[\w-]+)/editar/$', views.EditarCobro, name='editar_cobro'),
    # DETALLE COBRO
